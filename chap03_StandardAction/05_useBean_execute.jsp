...
<%
	...
	MemberDTO mbr2 = new MemberDTO("엄정화","9704062234567");
...
<body>
	...
	<div>
		...
		<%--
			...
			즉, chap03.MemberDTO 클래스의 기본생성자로 mbr3 이라는 객체를 생성한 것이다.
		--%>
		...
		<%-- 
			...
			+ property 는 set 다음 메소드명, 첫글자는 소문자로 작성할 것
		--%>
