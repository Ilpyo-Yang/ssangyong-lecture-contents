...
<jsp:forward page="03forwardCalc_view_03.jsp" />
<%-- 
	웹브라우저 상에서 URL 주소는
	http://localhost:9090/JSPServletBegin/chap03_StandardAction/03forwardCalc_02.jsp?firstNum=1&secondNum=10 인데
	웹브라우저 상에 보여지는 내용물은 http://localhost:9090/JSPServletBegin/chap03_StandardAction/03forwardCalc_view_03.jsp 의 내용이 보여진다. 
--%>