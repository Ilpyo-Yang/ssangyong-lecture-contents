		...
		try {
			...
			//         즉, 우편배달부(택배기사) 객체 만들기 
				...
				*/	
				...
				cstmt.registerOutParameter(3, java.sql.Types.VARCHAR); // 숫자 3은 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ?를 말한다.
				...
				cstmt.registerOutParameter(6, java.sql.Types.VARCHAR); // 숫자 6은 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ?를 말한다.
				cstmt.registerOutParameter(7, java.sql.Types.VARCHAR); // 숫자 7은 프로시저 파라미터중 두번째 파라미터인 OUT 모드의 ?를 말한다.
