...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		NoSingletonNumber a = new NoSingletonNumber();
		NoSingletonNumber b = new NoSingletonNumber();
		NoSingletonNumber c = new NoSingletonNumber();
		
		SingletonNumber d = new SingletonNumber();
		생성자를 private 으로 은닉화 했으므로 객체 생성이 불가하다
		*/
