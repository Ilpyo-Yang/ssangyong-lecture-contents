...
*/	
		...
		nameList.add(1234.5);		// double --> Double 오토박싱 되어짐
		
		nameList.add(new Integer(98));
		nameList.add(98);		// int --> Integer 로 오토박싱 되어짐
		...
		/* *** Array와 ArrayList의 차이점은
		   1. Array 은 크기가 한정되어져 있지만
		      Collection은 크기가 무한정 이다.
		   2. Array 은 배열의 크기가 선언되어진 동일한 타입의 데이터만 입력가능하지만
		      Collection은 입력되어지는 데이터가 객체이기만 하면 어떤 것이든지 가능하다.
		 */
 ...
 */
	...
	// 또는
		List<String> strList = new ArrayList<>();		// String은 생략가능한데 JDK 8부터 가능함.
	...
	//	mbrList.add(10); 	// 오류!! mbrList 에는 Generic으로 선언된 Member 객체만 들어오기 때문이다.
