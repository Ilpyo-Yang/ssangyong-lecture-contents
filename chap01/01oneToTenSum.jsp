...
<head>
<meta charset="UTF-8">
<title>1부커 10까지의 합을 자바에서 구한 다음 그 결과를 HTML로 보여줄 것이다</title>
<style type="text/css">
	span{color:red;}
</style>
</head>
...
%>
	<h2>
		1부터 10까지의 합은 <span><%=sum%></span>입니다.
	</h2>
	...
	<%-- 
        ...
        01oneToTenSum.jsp 라는 파일은 실제로는 확장자가 .java 인 파일로 저장되어서
                컴파일 되어진 확장자가 .class 인 파일로 저장되어지는데 어느 경로에 저장되는지 알아본다.
        ...
        C:\NCS\workspace(jsp)\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\JSPServletBegin\org\apache\jsp\chap01\_01oneToTenSum_jsp.class 로
                ...
                혹가다가  01oneToTenSum.jsp 라는 파일을 수정을 했지만 수정한대로 안 먹을 경우가 혹가다가 있다.
                이럴때 해결방법은 탐색기에서 _01oneToTenSum_jsp.java 파일과  _01oneToTenSum_jsp.class 파일을 삭제한다.
	...
	<h2>
		1부터 10까지의 합에 20을 더한값은 <span><%=sum+20%></span>입니다.
	</h2>
