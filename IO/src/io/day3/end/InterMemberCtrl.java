...
//	boolean duplicateIdGujikja(String id, Member[] mbrArr);
	boolean duplicateIdGujikja(String id, List<Member> mbrList);
...
//	boolean duplicateIdCompany(String id, Member[] mbrArr);
	boolean duplicateIdCompany(String id, List<Member> mbrList);
	// 아이디가 이미 존재한다라면 true 를 리턴.
	// 아이디가 존재하지 않는다라면 false 를 리턴.
