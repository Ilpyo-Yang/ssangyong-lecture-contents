 ...
 */
	...
	public static void main(String[] args) {
		...
		InterAreaFuctional_3 objA = (String state) -> {	System.out.println("웃음소리1 : "+state);};
		objA.smile("깔깔깔~~~~~~~~~~~~");
			// 웃음소리 : 깔깔깔~~~~~~~~~~~~
		
		// 2. 실행명령문이 1개라면 { } 를 생략할 수 있다.
		InterAreaFuctional_3 objB = (String state) -> System.out.println("웃음소리2 : "+state);
		objB.smile("헤헤헤");
			// 웃음소리2 : 헤헤헤
		
		// 3. 파라미터 타입은 생략할 수 있다.
		InterAreaFuctional_3 objC = (state) -> System.out.println("웃음소리3 : "+state);
		objC.smile("호호호");
			// 웃음소리3 : 호호호
		
		// 4. 파라미터 개수가 1개일 때는 파라미터를 감싸는 괄호 ( )를 생략할 수 있다.
		InterAreaFuctional_3 objD = state -> System.out.println("웃음소리4 : "+state);
		objD.smile("히히히");
			// 웃음소리4 : 히히히
				
		// 5. 파라미터가 없는 람다식은 무조건 괄호를 기재해야 한다.
		InterAreaFuctional_4 objE = ( ) -> System.out.println("안녕하세요~~~");
		objE.write( );
			// 안녕하세요~~~
		...
		//InterAreaFuctional_1 objG = (x, y) -> return x-y;  //오류
